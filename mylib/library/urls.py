...
from .views import LibraryView, LibraryDetailView, LibrarianDashboardView, AddBookView, BookDetailView, DeleteBookView,EditBookView, BorrowBookView, ReturnBookView
urlpatterns = [
